...
Date: 2026-08-02 22:22:16
Problem name: B. Eastern Exhibition
Problem URL: https://codeforces.com/problemset/problem/1486/B
Idea: 
Tag used: 
Summary: 
*/
...
void solve()
{
    ...
    sort(nall(x));
    sort(nall(y));
    int cntX = (n % 2 != 0) ? 1 : (x[n / 2] - x[n / 2 - 1] + 1);
    int cntY = (n % 2 != 0) ? 1 : (y[n / 2] - y[n / 2 - 1] + 1);
    cout << cntX * cntY << endl;
}
