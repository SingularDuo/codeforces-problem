...
Date: 2026-08-04 21:46:53
Problem name: C1. Marenol (easy version)
Problem URL: https://codeforces.com/contest/2254/problem/C1
Idea: 
Tag used: 
Summary: 
*/
...
{
    int cnt1 = 0, cnt2 = 0;
    for(char i : a) cnt1 += (i == '0');
    for(char i : b) cnt2 += (i == '0');
    return cnt1 == cnt2;
}
void solve()
{
    ...
    int cntC1 = 0, cntL1 = 0, cntC2 = 0, cntL2 = 0;
    for(int i = 0; i < n; i++)
    {
        cntC1 += (a[i] == '1' && i % 2 == 0);
        cntL1 += (a[i] == '1' && i % 2 != 0);
    ...
    if(cntC1 == cntC2 && cntL1 == cntL2)cout<<"YES"<<endl;
    else cout<<"NO"<<endl;
}
